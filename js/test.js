...
//   let correctAnswers = multipleChoiceAnswers[i]; // Update to use the correct array of answers
//   let attempts = 6;
...
//       alert('Congratulations! You guessed one of my favorite Animme correctly!');
...
//   if (guessedCorrectly) {
//     if (answer7 === 'no') { // Update answer7 to 'yes' only if it hasn't been set to 'yes' already
//       answer7 = 'yes';
//     }
